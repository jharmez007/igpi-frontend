...
const quickLink =
  "p__text text-zinc-500 hover:text-[#fcbe27] ease-in duration-300";
        ...
        <div className="w-full md:basis-1/6">
          <div className="flex flex-col gap-6 p__text text-zinc-500 md:text-sm mr-4 md:mr-0">
            ...
            <div className="leading-6 flex flex-col gap-3">
              ...
              <p>
                <span className="font-bold text-black">Address: </span>15, Owhor
                Street Rumuomoi by psychiatric hospital road, Port Harcourt
              </p>
            </div>
          </div>
        </div>
