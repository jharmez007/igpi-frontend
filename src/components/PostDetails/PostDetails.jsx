                    ...
                    <div className='flex items-center md:items-start flex-col md:flex-row gap-10'>
                        ...
                        <div className='flex flex-col w-full md:w-[350px] text-center md:text-left'>
							...
							<Link 
                                ...
                                state={{ post: suggestedPost, allPosts: location.state?.allPosts }}
                            >
                               <h3 className='p__text text-lg md:text-xl lg:text-2xl mb-4 hover:text-[#0b8b68] ease-in duration-300'>{suggestedPost.title}</h3>
                            </Link>
                            ...
                            <Link 
                                ...
                                state={{ post: suggestedPost, allPosts: location.state?.allPosts }}
                            >
                                <button className="border-2 border-[#0b8b68] text-[#0b8b68] text-sm py-1 md:py-2 px-9 uppercase rounded-sm font-bold hover:bg-[#0b8b68] hover:text-white ease-in duration-300">READ THIS</button>
                            </Link>
                        </div>
                    </div>
                </div>
