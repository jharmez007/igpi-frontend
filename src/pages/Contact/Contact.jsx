...
const Contact = () => {
  ...
  return (
    <div id="contact flex flex-col">
      ...
      <div className="app__flex flex-col-reverse lg:flex-row md:min-h-[90vh]">
        <div className="w-full h-full app__flex md:basis-1/2 p-8">
          <div className="app__flex flex-col gap-8 h-full">
            <h2 className="font-bold p__text text-4xl md:text-5xl text-center text-[#0b8b68]">
              Reach Out to Us
            </h2>
            <div className="app__flex flex-col gap-2">
              <p className="text-center p__text text-lg">
                15, Owhor Street Rumuomoi by psychiatric hospital road, Port
                Harcourt
              </p>
              <div className="flex flex-col lg:flex-row gap-1 lg:gap-4">
                <p className="text-center p__text text-lg">
                  Inclusivegrowth840@gmail.com
                </p>
            ...
            <div className="w-full">
              {!isFormSubmitted ? (
                ...
                <div className="app__flex mt-12">
                  <h3 className="p2__text text-5xl md:text-7xl text-center text-[#0b8b68]">
      ...
      <iframe
        title="location"
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1987.773453721332!2d6.995760547916217!3d4.847570068263317!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1069ce0570f9e5df%3A0xb357b4a901744eaa!2s15%20Owhor%20Street%2C%20Rumuigbo%2C%20Port%20Harcourt%20500272%2C%20Rivers!5e0!3m2!1sen!2sng!4v1727481573002!5m2!1sen!2sng"
        width="100%"
        height="450"
        style={{ border: "0" }}
        allowfullscreen=""
