            ...
            <div className="flex flex-row w-full text-white">
                <div className='news-column left float-left w-full lg:w-[33.333%] flex flex-col gap-8 lg:gap-0'>
                  <Link 
                    ...
                    className='relative h-auto lg:h-[400px] bg-[#0b8b68] hover:bg-[#fcbe27] p-8 transition duration-300'
                  >
                    {sortedPost.length > 0 ? (
                      <>
                ...
                <div className='news-column middle float-left lg:w-[33.333%] hidden lg:flex lg:flex-col pt-[110px]'>
                  ...
                  <Link 
                    ...
                    className='relative lg:h-[290px] bg-[#0b8b68] hover:bg-[#fcbe27] p-8 transition duration-300'
                  >
                    {sortedPost.length > 4 ? (
                      <>
                  ...
                  <Link 
                    ...
                    className='relative lg:h-[290px] bg-[#034b38] hover:bg-slate-200 hover:text-black p-8 transition duration-300'
                  >
                    {sortedPost.length > 5 ? (
                      <>
                  ...
                  <Link 
                    ...
                    className='relative h-auto lg:h-[290px] bg-[#0b8b68] hover:bg-[#fcbe27] p-8 transition duration-300'
                  >
                  {sortedPost.length > 6 ? (
                    <>
